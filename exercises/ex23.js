...
//1  write a while loop that prints out each item of ingredients.
let i = 0;
...
//2  Under the second, write a for loop that does the same thing.
for(let i = 0; i < ingredients.length; i++){
  console.log(ingredients[i])
}


//3  And under the third, write any loop, while or for that prints out each item of ingredients but backwards (that is, the first should be "bananas" and the last "eggs").
